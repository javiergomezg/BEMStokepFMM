...
from DL_potential import bbfmm_DL_potential#, direct_DL_potential
#from DL_potential import direct_DL_potential
...
def vector_Ax_fmm(T,S,nc,f,Rp,Xp,Yp,mu,nchebpol):
    Nq, Ns = len(T.z), len(S.z)
